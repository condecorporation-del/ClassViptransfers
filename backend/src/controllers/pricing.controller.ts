...
export class PricingController {
  ...
  async getPublicExtras(req: Request, res: Response) {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error.message || 'Failed to fetch extras',
      });
    }
  }
  ...
  async listExtras(req: Request, res: Response) {
    try {
      ...
      res.status(400).json({
        success: false,
        error: error.message || 'Failed to list pricing extras',
      });
    }
  }
  ...
  async createExtra(req: Request, res: Response) {
    try {
      ...
      res.status(400).json({
        success: false,
        error: error.message || 'Failed to create pricing extra',
      });
    }
  }
  ...
  async updateExtra(req: Request, res: Response) {
    try {
      ...
      res.status(400).json({
        success: false,
        error: error.message || 'Failed to update pricing extra',
      });
    }
  }
  ...
  async deleteExtra(req: Request, res: Response) {
    try {
      ...
      res.status(400).json({
        success: false,
        error: error.message || 'Failed to delete pricing extra',
      });
    }
  }
  ...
  async listAreas(req: Request, res: Response) {
    try {
      ...
      res.status(400).json({
        success: false,
        error: error.message || 'Failed to list areas',
      });
    }
  }
  ...
  async deactivateArea(req: Request, res: Response) {
    try {
      ...
      res.status(400).json({
        success: false,
        error: error.message || 'Failed to deactivate area',
      });
    }
  }
}
