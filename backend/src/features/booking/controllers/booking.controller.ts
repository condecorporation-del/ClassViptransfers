...
export class BookingController {
  ...
  async createBooking(req: Request, res: Response) {
    ...
    const booking = await bookingService.createDraftBooking(input, source as BookingSource);
  ...
  async getConfirmationPdf(req: Request, res: Response) {
    ...
    try {
      ...
      console.error('[Booking] PDF generation failed:', message);
  ...
  async getBooking(req: Request, res: Response) {
    ...
    const token = typeof req.query.token === 'string' ? req.query.token : null;
    const isAdmin = Boolean(req.adminEmail);
