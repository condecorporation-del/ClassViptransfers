      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="mailto:Armando@classviptransfers.com" className="flex items-center gap-2 text-off-white/60 text-sm hover:text-off-white transition-colors">
        ...
        <div className="flex flex-col items-center gap-4 mb-6">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-semibold text-off-white/70 hover:text-gold transition-colors"
          >
            <Star className="h-5 w-5 fill-gold text-gold shrink-0" aria-hidden />
            TripAdvisor
          </a>
        ...
        <div className="text-center text-off-white/40 text-xs flex flex-col items-center justify-center gap-2">
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            <Link
              to="/admin/login"
              className="text-gold/70 hover:text-gold font-semibold transition-colors"
            >
              Admin ⚡
            </Link>
          </div>
